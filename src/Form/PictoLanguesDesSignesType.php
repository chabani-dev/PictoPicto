...
class PictoLanguesDesSignesType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('pictograms', EntityType::class, [
                'label' => 'Pictogramme Langues Des Signes:',
                'required' => false,
                'class' => Category::class,
                'choice_label' => 'name',
                 'choices' => $this->repo->findBy(['name' => 'Langues Des Signes']),
                'attr' => [
                    'class' => 'form-select'
                ],
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => PictoLanguesDesSignes::class,
        ]);
    }
}
