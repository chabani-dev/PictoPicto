...
class PictoSecuriteRoutiereType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('pictograms', EntityType::class, [
                'label' => 'Pictogramme Securite Routiere:',
                'required' => false,
                'class' => Category::class,
                'choice_label' => 'name',
                 'choices' => $this->repo->findBy(['name' => 'Sécurité Routière']),
                'attr' => [
                    'class' => 'form-select'
                ],
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => PictoSecuriteRoutiere::class,
        ]);
    }
}
