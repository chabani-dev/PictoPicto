...
class PictoFruitsLegumesType extends AbstractType
{
    private $repo;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('pictograms', EntityType::class, [
                'label' => 'Pictogramme Fruits et Legumes :',
                'required' => false,
                'class' => Category::class,
                'choice_label' => 'name',
                 'choices' => $this->repo->findBy(['name' => 'Fruits et légumes']),
                'attr' => [
                    'class' => 'form-select'
                ],
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => PictoFruitsLegumes::class,
        ]);
    }
}
