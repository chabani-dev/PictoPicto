...
class PictoInterrogatifType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('pictograms', EntityType::class, [
                'label' => 'pictogramme Interrogatif:',
                'required' => false,
                'class' => Category::class,
                'choice_label' => 'name',
                 'choices' => $this->repo->findBy(['name' =>'Interrogatif']),
                'attr' => [
                    'class' => 'form-select'
                ],
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => PictoInterrogatif::class,
        ]);
    }
}
