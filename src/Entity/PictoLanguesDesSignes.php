...
/**
 * @ORM\Entity(repositoryClass=PictoLanguesDesSignesRepository::class)
 * @Vich\Uploadable()
 */
class PictoLanguesDesSignes
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoLanguesDesSignes")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoLanguesDesSignes")
     */
    private $therapist;
