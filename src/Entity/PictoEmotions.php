...
/**
 * @ORM\Entity(repositoryClass=PictoEmotionsRepository::class)
 * @Vich\Uploadable()
 */
class PictoEmotions
{
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoEmotions")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoEmotions")
     */
    private $therapist;
