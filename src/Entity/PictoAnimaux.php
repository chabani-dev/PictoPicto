...
/**
 * @ORM\Entity(repositoryClass=PictoAnimauxRepository::class)
 * @Vich\Uploadable()
 */
class PictoAnimaux
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoAnimauxes")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoAnimauxes")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoAnimauxes")
     */
    private $therapist;
