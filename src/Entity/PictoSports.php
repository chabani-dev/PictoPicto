...
/**
 * @ORM\Entity(repositoryClass=PictoSportsRepository::class)
 * @Vich\Uploadable()
 */
class PictoSports
{
   ...
   /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoSports")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoSports")
     */
    private $therapist;
