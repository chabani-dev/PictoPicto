...
/**
 * @ORM\Entity(repositoryClass=PictoScolariteRepository::class)
 * @Vich\Uploadable()
 */
class PictoScolarite
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
   ...
   /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoScolarites")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoScolarites")
     */
    private $therapist;
