...
/**
 * @ORM\Entity(repositoryClass=PictoJourneesRepository::class)
 * @Vich\Uploadable()
 */
class PictoJournees
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoJournees")
     */
    private $pictograms;

    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoJournees")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoJournees")
     */
    private $therapist;
