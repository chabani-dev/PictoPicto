...
/**
 * @ORM\Entity(repositoryClass=PictoOrientationRepository::class)
 * @Vich\Uploadable()
 */
class PictoOrientation
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups("pictoorientation")
     */
    private $id;
   ...
   /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoOrientations")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoOrientations")
     */
    private $therapist;
