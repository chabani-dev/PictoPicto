...
/**
 * @ORM\Entity(repositoryClass=PictoVetementsRepository::class)
 * @Vich\Uploadable()
 */
class PictoVetements
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups("pictovetements")
     */
    private $id;
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoVetements")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoVetements")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoVetements")
     */
    private $therapist;
