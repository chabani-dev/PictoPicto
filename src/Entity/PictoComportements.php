...
/**
 * @ORM\Entity(repositoryClass=PictoComportementsRepository::class)
 * @Vich\Uploadable()
 */
class PictoComportements
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups("pictocomportements")
     */
    private $id;
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoComportements")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoComportements")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoComportements")
     */
    private $therapist;
