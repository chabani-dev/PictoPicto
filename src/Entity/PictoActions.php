...
/**
 * @ORM\Entity(repositoryClass=PictoActionsRepository::class)
 * @Vich\Uploadable()
 */
class PictoActions
{
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoActions")
     * @Groups("pictoActions")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoActions")
     */
    private $therapist;
