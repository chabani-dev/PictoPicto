...
/**
 * @ORM\Entity(repositoryClass=PictoInterrogatifRepository::class)
 * @Vich\Uploadable()
 */
class PictoInterrogatif
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoInterrogatifs")
     */
    private $pictograms;

    
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoInterrogatifs")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoInterrogatifs")
     */
    private $therapist;
