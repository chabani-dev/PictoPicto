...
/**
 * @ORM\Entity(repositoryClass=PictoSecuriteRoutiereRepository::class)
 * @Vich\Uploadable()
 */
class PictoSecuriteRoutiere
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups("pictosecuriteroutiere")
     */
    private $id;
   ...
   /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoSecuriteRoutieres")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoSecuriteRoutieres")
     */
    private $therapist;
