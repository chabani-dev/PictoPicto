...
/**
 * @ORM\Entity(repositoryClass=PictoCorpsHumainRepository::class)
 * @Vich\Uploadable()
 */
class PictoCorpsHumain
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups("pictocorpshumain")
     */
    private $id;
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoCorpsHumains")
