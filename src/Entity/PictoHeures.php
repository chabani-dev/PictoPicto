...
/**
 * @ORM\Entity(repositoryClass=PictoHeuresRepository::class)
 * @Vich\Uploadable()
 */
class PictoHeures
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoHeures")
     */
    private $pictograms;

    
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoHeures")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoHeures")
     */
    private $therapist;
