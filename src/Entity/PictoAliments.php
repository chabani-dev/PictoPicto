...
/**
 * @ORM\Entity(repositoryClass=PictoAlimentsRepository::class)
 * @Vich\Uploadable()
 */
class PictoAliments
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoAliments")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoAliments")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoAliments")
     */
    private $therapist;
