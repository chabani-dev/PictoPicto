...
/**
 * @ORM\Entity(repositoryClass=PictoChiffresRepository::class)
 * @Vich\Uploadable()
 */
class PictoChiffres
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoChiffres")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoChiffres")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoChiffres")
     */
    private $therapist;
