...
/**
 * @ORM\Entity(repositoryClass=PictoAutresMotsRepository::class)
 * @Vich\Uploadable()
 */
class PictoAutresMots
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoAutresMots")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoAutresMots")
     */
    private $therapist;
