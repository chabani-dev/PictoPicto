...
/**
 * @ORM\Entity(repositoryClass=PictoFormesRepository::class)
 * @Vich\Uploadable()
 */
class PictoFormes
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoFormes")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoFormes")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoFormes")
     */
    private $therapist;
