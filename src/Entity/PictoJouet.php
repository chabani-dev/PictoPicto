...
/**
 * @ORM\Entity(repositoryClass=PictoJouetRepository::class)
 * @Vich\Uploadable()
 */
class PictoJouet
{
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoJouets")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoJouets")
     */
    private $therapist;
