...
/**
 * @ORM\Entity(repositoryClass=PictoObjetsRepository::class)
 * @Vich\Uploadable()
 */
class PictoObjets
{
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoObjets")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=SubCategory::class, inversedBy="pictoObjets")
     */
    private $subcategory_id;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoObjets")
     */
    private $therapist;
