...
/**
 * @ORM\Entity(repositoryClass=PictoFruitsLegumesRepository::class)
 * @Vich\Uploadable()
 */
class PictoFruitsLegumes
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @Groups("pictofruitslegumes")
     */
    private $id;
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoFruitsLegumes")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoFruitsLegumes")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoFruitsLegumes")
     */
    private $therapist;
