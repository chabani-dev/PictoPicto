...
/**
 * @ORM\Entity(repositoryClass=PictoSujetsRepository::class)
 * @Vich\Uploadable()
 */
class PictoSujets
{
   ...
   /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoSujets")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoSujets")
     */
    private $therapist;
