...
/**
 * @ORM\Entity(repositoryClass=PictoCouvertsRepository::class)
 * @Vich\Uploadable()
 */
class PictoCouverts
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Category::class, inversedBy="pictoCouverts")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Sentence::class, inversedBy="pictoCouverts")
     */
    private $sentences;

    /**
     * @ORM\ManyToOne(targetEntity=Therapist::class, inversedBy="pictoCouverts")
     */
    private $therapist;
