...
function wordByword() {
  ...
  if (countWord === tabWord.length - 1) {
    // si le compteur est égale à la taille du tableau -1 alors on remplace le mot lu par un span avec une classe speciale et on remet le compteur à 0
    ...
    let replace = sentence.replace(
      brightWord,
      '<span class="brightWord">' + brightWord + "</span>"
    );
    // console.log(replace);
    $("#sentenceText").html(replace);
    countWord = 0;
  } else {
    // sinon on fait la même chose mais on incrémente le compteur pour lire le mot suivant
    speech.text = tabWord[countWord];
    speech.pitch = 1; // 0 à 2 = Hauteur
    speech.rate = 1; // 0.5 à 2 = Vitesse
    speech.volume = 0.5; // 0 à 1 = Volume
...
function textUpdate() {
  ...
  let i = 1;
  $(".drop").each(function () {
    // Parcourt les zones de drop
    if (
      $("#mot" + i)
        .children()
        .attr("alt") !== undefined
    ) {
      // Si la zone de drop contient un picto
      pictoWord = $("#mot" + i)
        .children()
        .attr("alt"); // Récupère le mot correspondant au pictogramme
      if (
        pictoWord == "l'" ||
        pictoWord == "L'" ||
        pictoWord == "j'" ||
  ...
  sentence =
    sentence.charAt(0).toUpperCase() + sentence.substring(1).toLowerCase(); // Met la première lettre de la phrase en majuscule, et le reste en minuscule
...
// $("#ques").click(() => {
//   // Au click sur le bouton "ques"
//   quesUpdate(); // Fait le traitement relatif à l'interrogative
// });

// /* Mise à jour de la phrase question */
// function quesUpdate() {
...
//   });
//   if (pictograms.length <= 1) {
//     alert("La phrase n'est pas assez complète pour être en intérrogative");
//   } else if (pictograms.length >= 2) {
//     getDataQuest("/api/get/pictogram"); // (récupère les variantes du pictogramme pour l'interrogative)
//   }
//   let sentence = pictograms.join(""); // Join les éléments du tableau par un espace
//   starLevel(sentence);
//   sentence =
...
function starLevel(sentence) {
  ...
  } // modifie la couleur de l'étoile en fonction du nombre de pictogrammes droppés
  if (picto === 1) {
    star.style.color = "#fff2d4";
  }
  if (picto === 2) {
    star.style.color = "#eed58f";
  }
  if (picto === 3) {
    star.style.color = "#ffe79b";
  }
  if (picto === 4) {
    star.style.color = "#fade5d";
  }
  if (picto === 5) {
    star.style.color = "#fdd54b";
  }
  if (picto === 6) {
    star.style.color = "#eee310";
  }
}
/* end Star */
...
/* Négatif/Affirmatif */
$("#neg").click(() => {
  // Au click sur le bouton "négation"
...
$("#passe").click(() => {
  // Au click sur le bouton "passé"
  passeUpdate(); // Fait le traitement relatif à la passé
});

// document.getElementById("mot1").ondblclick = function () {
//   myFunction1();
// };
function myFunction1() {
  ...
  if (varName1 === "mot1") {
    $("#mot1 > img").remove();
    $("#mot1").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot2").ondblclick = function () {
//   myFunction2();
// };
function myFunction2() {
  ...
  if (varName2 === "mot2") {
    $("#mot2 > img").remove();
    $("#mot2").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot3").ondblclick = function () {
//   myFunction3();
// };
function myFunction3() {
  ...
  if (varName3 === "mot3") {
    $("#mot3 > img").remove();
    $("#mot3").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot4").ondblclick = function () {
//   myFunction4();
// };
function myFunction4() {
  ...
  if (varName4 === "mot4") {
    $("#mot4 > img").remove();
    $("#mot4").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot5").ondblclick = function () {
//   myFunction5();
// };
function myFunction5() {
  ...
  if (varName5 === "mot5") {
    $("#mot5 > img").remove();
    $("#mot5").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot6").ondblclick = function () {
//   myFunction6();
// };
function myFunction6() {
  ...
  if (varName6 === "mot6") {
    $("#mot6 > img").remove();
    $("#mot6").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot7").ondblclick = function () {
//   myFunction7();
// };
function myFunction7() {
  ...
  if (varName7 === "mot7") {
    $("#mot7 > img").remove();
    $("#mot7").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot8").ondblclick = function () {
//   myFunction8();
// };
function myFunction8() {
  ...
  if (varName8 === "mot8") {
    $("#mot8 > img").remove();
    $("#mot8").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot9").ondblclick = function () {
//   myFunction9();
// };
function myFunction9() {
  ...
  if (varName9 === "mot9") {
    $("#mot9 > img").remove();
    $("#mot9").removeClass("pictoPresent");
  }
  textUpdate();
}
// document.getElementById("mot10").ondblclick = function () {
//   myFunction10();
// };
function myFunction10() {
  ...
  if (varName10 === "mot10") {
    $("#mot10 > img").remove();
    $("#mot10").removeClass("pictoPresent");
  }
  textUpdate();
}
