...
function filterPictogram(question) {
  ...
  if (questionSelected === "Quel âge as-tu ?") {
    // Si la question sélectionnée correspond à telle chaîne de caractères
    ...
    questionSelected === "Comment te sens-tu quand tu es à l'école ?"
  ) {
    categoryQuestion = ["Émotions"];
  } else if (
    questionSelected === "Comment te sens-tu quand tu es à la maison ?"
  ) {
    categoryQuestion = ["Émotions"];
    ...
    questionSelected === "Quels vêtements choisir quand il fait froid ?"
  ) {
    ...
    questionSelected === "Quelle partie de ton corps permet d'entendre ?"
  ) {
    categoryQuestion = ["Corps humain"];
    ...
    questionSelected === "De quelle couleur est l'herbe dans le jardin ?"
  ) {
    categoryQuestion = ["Couleurs"];
    ...
    questionSelected ===
    "Avec quel moyen de transport peut-on aller dans l'espace ?"
  ) {
    categoryQuestion = ["Transports"];
  } else if (questionSelected === "Quel couvert tu veux utiliser ?") {
    categoryQuestion = ["Couverts"];
  } else if (questionSelected === "A quel moment de la journée sommes nous ?") {
    categoryQuestion = ["Journee"];
  } else if (questionSelected === "Quelle heure est il ?") {
    categoryQuestion = ["Heures"];
  } else {
    // Sinon affiche les toutes
    categoryQuestion = [
      "Sujets",
      "Boissons",
      "Actions",
  ...
  $(".contentP .picto").each(function () {
    // Pour chaque pictogramme
    if (categoryQuestion.includes($(this).attr("title"))) {
      // Si la catégorie du pictogramme correspond à la question
